...
import 'package:practice_3/widgets/box_list.dart';
import 'package:practice_3/widgets/circle_list.dart';
import 'package:practice_3/widgets/poster.dart';
import 'package:practice_3/widgets/poster_buttons.dart';
    ...
    return Scaffold(
      appBar: AppBar(
          ...
          title: Row(
            ...
            children: [
              Text('TV프로그램', style: TextStyle(fontSize: 12)),
              Text('영화', style: TextStyle(fontSize: 12)),
              Text('콘텐츠', style: TextStyle(fontSize: 12)),
            ],
          )),
      body: ListView(
        children: [
          Poster(), //Poster
          PosterButtons(), // Poster Button
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: [
          ...
          BottomNavigationBarItem(icon: Icon(Icons.save_alt), label: '저장'),
